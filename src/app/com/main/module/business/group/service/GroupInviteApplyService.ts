...
export default class GroupInviteApplyService extends AbstractMaterial {
    ...
    public queryInviteApplyDataReceiveList(query: GroupInviteApplyQuery,
        ...
        sender.queryInviteApplyReceiveList(query, page, this.appContext.createDataBackAction((data: any) => {
            if (data && data.body) {
