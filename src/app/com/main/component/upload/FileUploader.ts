...
import AbstractUploader from '@/app/com/main/component/upload/AbstractUploader';
import ServerAddress from '@/app/com/bean/ServerAddress';
import FileSeverApi from '@/app/com/main/constant/FileSeverApi';

export default class FileUploader extends AbstractUploader {
    ...
    public getPath(): string {
        return FileSeverApi.FILE_UPLOAD;
    }
