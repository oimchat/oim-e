...
export default abstract class AbstractClassicalBag extends AbstractBag {
    ...
    public initialize(faceCategory: FaceCategory): void {
        ...
        this.put('classical,40,闪人', true);
        this.put('classical,41,发抖', true);
        this.put('classical,42,爱情', true);
        this.put('classical,43,跳跳', true);
        this.put('classical,44,找', true);
        this.put('classical,45,美眉', true);
        this.put('classical,46,猪头', true);
        this.put('classical,47,猫咪', true);
        this.put('classical,48,小狗', true);
        this.put('classical,49,拥抱', true);
        this.put('classical,50,人民币', true);
        this.put('classical,51,灯泡', true);
        this.put('classical,52,酒杯', true);
        ...
        this.put('classical,68,会议', true);
        this.put('classical,69,礼物', true);
        this.put('classical,70,电话', true);
        this.put('classical,71,时间', true);
        this.put('classical,72,邮件', true);
        this.put('classical,73,电视', true);
        ...
        this.put('classical,80,多多', true);
        this.put('classical,81,美女', true);
        this.put('classical,82,汉良', true);
        this.put('classical,83,毛毛', true);
        this.put('classical,84,Q仔', true);
        this.put('classical,85,飞吻', true);
        this.put('classical,86,怄火', true);
        this.put('classical,87,白酒', true);
        this.put('classical,88,汽水', true);
        this.put('classical,89,西瓜', true);
        this.put('classical,90,下雨', true);
        this.put('classical,91,多云', true);
        this.put('classical,92,雪人', true);
        this.put('classical,93,星星', true);
        this.put('classical,94,女', true);
        this.put('classical,95,男', true);
        ...
        this.put('classical,125,转圈', true);
        this.put('classical,126,磕头', true);
        this.put('classical,127,回头', true);
        this.put('classical,128,跳绳', true);
        this.put('classical,129,挥手', true);
        this.put('classical,130,激动', true);
        this.put('classical,131,街舞', true);
        this.put('classical,132,献吻', true);
        this.put('classical,133,左太极', true);
        this.put('classical,134,右太极', true);
        ...
        this.put('classical,193,大笑', true);
        this.put('classical,194,不开心', true);
        this.put('classical,195,啊', true);
        this.put('classical,196,冷汗', true);
        this.put('classical,197,冷漠', true);
        this.put('classical,198,呃', true);
        this.put('classical,199,好棒', true);
        ...
        this.put('classical,213,哇哦', true);
